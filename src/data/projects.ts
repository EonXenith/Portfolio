...
export const projects: Project[] = [
  ...
  },
  {
    id: "04",
    title: "Starfarer",
    summary: "Explore a procedurally generated galaxy in 3D, starting from Earth.",
    description:
      "Starfarer is a browser-based 3D space exploration game. Pick a spaceship, launch from Sol, and navigate through a procedurally generated galaxy — discovering new star systems, scanning planets, and charting unexplored space. No currency, no fuel meters, no survival mechanics — just pure exploration. The game tracks your discoveries during a session: visited systems, scanned locations, and explored planets.\n\nBuilt on vanilla Three.js with modular JavaScript — galaxy generation, procedural planet textures, and star system data are all separated into their own modules. Planet textures are sourced from Solar System Scope under CC-BY-4.0 with procedural fallbacks for undiscovered worlds. New star systems can be added by editing a single data config file, making the galaxy easy to expand.",
  ...
  },
  {
    id: "05",
    title: "Coming Soon",
    summary: "New project in development. Stay tuned.",
    description:
      "This slot is reserved for an upcoming project currently in development. Check back soon.",
    tech: ["TBD"],
    status: "WIP",
